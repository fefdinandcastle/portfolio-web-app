export const translations = {
  es: {
    ...
    hero: {
      badge: 'PORTAFOLIO',
      headline1: 'Desarrollando productos',
      highlight: 'web',
      headline2: 'con visión técnica.',
      bio: 'Soy Gerardo Lerma, desarrollador frontend y líder técnico con enfoque en producto y experiencia de usuario. Coordino desarrollo back-end en Java y front-end en React, además de infraestructura en GCP, Jenkins y planeación de sprints.',
      linkedin: 'LinkedIn',
      cv: 'Descargar CV',
    },
    experience: {
  ...
  en: {
    ...
    hero: {
      badge: 'PORTFOLIO',
      headline1: 'Developing',
      highlight: 'web',
      headline2: 'products with a technical vision.',
      bio: "I'm Gerardo Lerma, a frontend developer and technical lead focused on product and user experience. I coordinate back-end development in Java and front-end in React, along with GCP infrastructure, Jenkins, and sprint planning.",
      linkedin: 'LinkedIn',
      cv: 'Download CV',
    },
    experience: {
