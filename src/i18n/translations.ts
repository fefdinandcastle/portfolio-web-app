export const translations = {
  es: {
    ...
    hero: {
      ...
      bio: 'Soy [Tu Nombre], desarrollador de software full-stack. Experiencia en entornos corporativos con Angular, React, Spring Boot, Oracle SQL y ciclo completo de entrega: desde scripts y datos hasta incidencias en producción.',
      linkedin: 'LinkedIn',
      github: 'GitHub',
    },
    experience: {
  ...
  en: {
    ...
    hero: {
      ...
      bio: "I'm [Your Name], a full-stack software developer. Experience in corporate environments with Angular, React, Spring Boot, Oracle SQL and complete delivery cycle: from scripts and data to production incidents.",
      linkedin: 'LinkedIn',
      github: 'GitHub',
    },
    experience: {
